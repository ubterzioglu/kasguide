...
/* ================================
   MEYHANE LONGTEXT TEMPLATE
   ================================ */
const MEYHANE_LONGTEXT_TEMPLATE = `
[MEYHANE UZUN AÇIKLAMA ŞABLONU]

1) Kısa Özet
- {{mekan}} Kaş’ta {{kısa_karakter}} bir meyhane deneyimi sunuyor.

2) Atmosfer & Vibe
- Ortam, müzik, kalabalık durumu.

3) Meze & Lezzet
- İmza mezeler, sıcaklar, kapanış.

4) Rakı & İçecek
- Rakı seçenekleri ve servis.

5) Fiyat & Zamanlama
- Ortalama fiyat, en iyi saatler.

6) Ulaşım & Tüyolar
- Konum, rezervasyon, küçük ipuçları.
`;
...
const categories = [
  ...
  /* ================================
   NEW-ADD: MEYHANE (START)
   Bu blok: Kaş meyhaneleri - yeni eklenenler
   Not: İşlediğin item’larda aşağıdaki `ubtStatus` alanını "done" yapabilirsin.
   ================================ */

{
  id: 'echo-meyhane',
  title: 'Echo Bar & Meyhane',
  description: 'Akşamları meyhane konseptine dönen, rakı–meze ve müzik eşliğinde keyifli bir mekan.',
  ...
  // Meta / takip alanı (senin için)
  ubtStatus: 'todo', // todo | done
  ubtNote: 'NEW-ADD: meyhane',

  location: 'Kaş merkez',
  distance: 'Merkez',
  coordinates: { lat: 36.1995, lng: 29.6362 },
  website: '',
  phone: '',
  duration: '2-3 saat',
  facilities: ['Rakı', 'Meze', 'Müzik', 'Akşam konsepti'],

  longText: MEYHANE_LONGTEXT_TEMPLATE
},

{
  id: 'bi-lokma-meyhane',
  title: 'Bi Lokma Meyhane',
  description: 'Ev yapımı mezeler, sakin ortam ve klasik meyhane hissi.',
  category: ['meyhane', 'food'],
  image: '',
  rating: 4.5,
  price: '₺₺',
  ...
  phone: '',
  duration: '2 saat',
  facilities: ['Ev yapımı mezeler', 'Rakı', 'Samimi ortam'],
...

{
  id: 'derya-meyhane',
  title: 'Derya Meyhane',
  description: 'Akşamları meyhane konseptinde hizmet veren, deniz kenarında meze ve rakı keyfi.',
  category: ['meyhane', 'food'],
  image: '',
  rating: 4.7,
  price: '₺₺₺',
  ...
  phone: '',
  duration: '2-3 saat',
  facilities: ['Deniz manzarası', 'Rakı', 'Meze', 'Akşam servisi'],
...
{
  id: 'smileys-meyhane',
  title: "Smiley's Meyhane",
  description: 'Akşam saatlerinde meyhane havasına giren, rakı ve deniz ürünleriyle bilinen mekan.',
  category: ['meyhane', 'food'],
  image: '',
  rating: 4.6,
  price: '₺₺₺',
  ...
  phone: '',
  duration: '2-3 saat',
  facilities: ['Rakı', 'Deniz ürünleri', 'Akşam konsepti'],
...

{
  id: 'zaika-meyhane',
  title: 'Zaika Meyhane',
  description: 'Ocakbaşı kökenli ama akşamları meyhane ruhuna bürünen popüler mekan.',
  category: ['meyhane', 'food'],
  image: '',
  rating: 4.6,
  price: '₺₺',
  ...
  phone: '',
  duration: '2 saat',
  facilities: ['Rakı', 'Sıcak mezeler', 'Akşam servisi'],
...

{
  id: 'mezze-kas',
  title: 'Mezze Kaş',
  description: 'Meze ağırlıklı, sakin ve klasik meyhane atmosferi sunan küçük mekan.',
  category: ['meyhane', 'food'],
  image: '',
  rating: 4.4,
  price: '₺₺',
  ...
  location: 'Kaş merkez',
  distance: 'Merkez',
  coordinates: { lat: 36.1988, lng: 29.6360 },
  website: '',
  phone: '',
  duration: '2 saat',
  facilities: ['Meze', 'Rakı', 'Sessiz ortam'],
...

{
  id: 'sofa-meyhane',
  title: 'Sofa Meyhane',
  description: 'Akşamları meyhane konseptiyle hizmet veren, samimi ve yerel bir mekan.',
  category: ['meyhane', 'food'],
  image: '',
  rating: 4.3,
  price: '₺₺',
  ...
  location: 'Kaş çarşı',
  distance: 'Merkez',
  coordinates: { lat: 36.1990, lng: 29.6365 },
  website: '',
  phone: '',
  duration: '2 saat',
  facilities: ['Rakı', 'Meze', 'Yerel ortam'],
