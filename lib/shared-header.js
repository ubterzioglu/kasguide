...
function initSharedHeader(config = {}) {
  ...
  headerContainer.innerHTML = `
    <header class="header">
      <div class="container header-content">
        ...
        <!-- LOGO (Sadece "Kaş" yazısı, ortada) -->
        <div class="logo logo-centered">
          <h1 class="logo-text">Kaş</h1>
        </div>
  ...
  // Mobile menu'i header container'ının dışına, body'ye ekle
  if (showMenu) {
    ...
    // Header container'ından sonra ekle
    headerContainer.insertAdjacentHTML('afterend', mobileMenuHTML);
  }
